  ...
  return <div className="integration-workspace">
    ...
    <section className="integration-grid">
      ...
      <section className="panel-card integration-preview">
        ...
        <footer className="integration-actions"><small>Removed records become reconciliation warnings. Event Manager OS never silently deletes the destination copy.</small><div><button className="button button-quiet" type="button" disabled={busy || !resource.data.connection} onClick={createPreview}><RefreshCcw size={15} /> Create mutation-free preview</button><button className="button button-accent" type="button" disabled={busy || !applicableRunId} onClick={applyPreview}>Apply approved preview <ArrowRight size={15} /></button></div></footer>
      </section>
    </section>
